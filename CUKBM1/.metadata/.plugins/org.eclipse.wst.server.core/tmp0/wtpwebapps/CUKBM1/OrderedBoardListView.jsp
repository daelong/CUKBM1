  ...
  <div id="wrap" class="row-fluid wrap">
    ...
    <aside class="well span3 oc" id="side-menu" role="navigation">
      <ul class="nav nav-list">
        ...
        <li><a href="Board?SUBJECT=tabletennis&TEAM=1">팀경기</a></li>
        ...
        <li class="nav-header">FREE</li>
         <li><a href="freeBoard?SUBJECT=free">자유게시판</a></li>
      </ul>
    </aside>
    ...
    <section class="well span9 ">
      ...
      <br> 
    <a class="a_heart" title="상위  인기게시글 30개를 확인할 수 있습니다" href="orderedBoard?SUBJECT=${param.SUBJECT}&TEAM=${param.TEAM}">&#9873;인기 게시글</a>
